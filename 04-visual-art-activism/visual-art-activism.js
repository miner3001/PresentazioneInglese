/* ===== Visual Art & Activism — Chapter 04 JS ===== */
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    setupPopup('banksyImage', 'banksyPopup', 'banksyClose');
    setupPopup('faireyImage', 'faireyPopup', 'faireyClose');
    setupPopup('weiweiImage', 'weiweiPopup', 'weiweiClose');
